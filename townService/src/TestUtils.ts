...
export type ClientEventTypes = ReservedOrUserEventNames<Server, ClientToServerEvents>;
 ...
 */
export function getEventListener<Ev extends ReservedOrUserEventNames<Server, ClientToServerEvents>>(
